...
## Description
This project demonstrates how to configure the DAC (Digital to Analog Converter) peripheral of the ATSAMD21 as a sine wave generator.
...
2. Observe the generated sine wave in the PicoScope.
